...
class deepWBnet(nn.Module):
    ...
    #     self.encoder_down2 = DownBlock(48, 96)
    #     self.encoder_down3 = DownBlock(96, 192)
    #     self.encoder_down4 = BridgeDown(192, 384)
    #     # self.encoder_bridge_down = BridgeDown(384, 768)
    #     # self.decoder_bridge_up = BridgeUP(768, 384)
    #     self.decoder_up1 = BridgeUP(384, 192)
    #     self.decoder_up2 = UpBlock(192, 96)
    #     self.decoder_up3 = UpBlock(96, 48)
    #     self.decoder_up4 = UpBlock(48, 24)
    #     self.decoder_out = OutputBlock(24, self.n_channels)
    ...
    #     x6 = self.encoder_bridge_down(x4)
    #     x = self.decoder_bridge_up(x6)
    #     # x = self.decoder_up1(x, x5)
    #     x = self.decoder_up2(x, x4)
    #     x = self.decoder_up3(x, x3)
    #     x = self.decoder_up4(x, x2)
    #     out = self.decoder_out(x, x1)
    #     return out
